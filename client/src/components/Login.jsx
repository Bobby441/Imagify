      ...
      viewport={{once:true}}
       className="relative bg-white p-10 rounded-xl text-slate-500">
        ...
        {state !== 'Login' && <div className="border px-6 py-2 flex items-center gap-2 rounded-full mt-5">
          <img className="" width={15} src={assets.user_icon} alt="" />
        ...
        {state === 'Login' ? <p className="mt-5 text-center">Don&apos;t have an account? <span className='text-blue-600 cursor-pointer' onClick={() => setState('Sign Up')}>Sign up</span> </p> : <p className="mt-5 text-center">Already have an account? <span onClick={() => setState('Login')} className='text-blue-600 cursor-pointer'>Login</span> </p>}
